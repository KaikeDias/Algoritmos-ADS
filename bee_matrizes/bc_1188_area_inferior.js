...
import fs from 'fs'
var input = fs.readFileSync('area_inferior.txt', 'utf8');
...
const area_inferior = (i,j,ordem) => abaixo_diagonal_principal(i,j) && abaixo_diagonal_secundaria(i,j,ordem)
