...
import fs from 'fs'
var input = fs.readFileSync('area_superior.txt', 'utf8');
...
const area_superior = (i,j,ordem) => acima_diagonal_principal(i,j) && acima_diagonal_secundaria(i, j, ordem)
