...
import fs from 'fs'
var input = fs.readFileSync('area_esquerda.txt', 'utf8');
...
const area_esquerda = (i,j,ordem) => abaixo_diagonal_principal(i,j) && acima_diagonal_secundaria(i,j,ordem)
