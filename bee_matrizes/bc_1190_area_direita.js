...
import fs from 'fs'
var input = fs.readFileSync('area_direita.txt', 'utf8');
...
const area_direita = (i,j,ordem) => acima_diagonal_principal(i,j) && abaixo_diagonal_secundaria(i,j,ordem)
